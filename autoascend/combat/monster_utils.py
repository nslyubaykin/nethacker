...
# hypothesis: a large no-adjacency penalty around petrifying monsters prevents
# otherwise fatal contact while retaining ranged attacks and normal exploration.
