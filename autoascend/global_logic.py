    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                ...
                # hypothesis: leaving the first-level XP farm when carried food is
                # exhausted prevents starvation while finding fresh corpses and food
                # on deeper levels for every barbarian identity.
