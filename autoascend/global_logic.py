    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: leaving the depleted first level at XP 6 avoids
                # starvation from prolonged spawn-farming while still giving
                # every Barbarian enough early hit points for the next levels.
