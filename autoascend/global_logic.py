    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: abandoning an exhausted Dlvl 1 before weakness
                # prevents starvation deaths, while retaining the usual XP 8
                # preparation whenever food remains available.
