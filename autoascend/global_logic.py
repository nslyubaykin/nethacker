    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                ...
                # hypothesis: descending once the starting level has no carried food
                # and the barbarian is hungry avoids starving while grinding an
                # exhausted level-1 population, and exposes fresh food and monsters.
