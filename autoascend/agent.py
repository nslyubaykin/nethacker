...
class Agent:
    ...
    def emergency_strategy(self):
        ...
        if (
                # hypothesis: using identified healing before health falls below 40%
                # prevents ordinary multi-damage melee turns from ending otherwise
                # recoverable Barbarian runs.
